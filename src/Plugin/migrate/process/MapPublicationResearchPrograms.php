 ...
 *   id = "map_publication_research_programs"
 * )
 */
class MapPublicationResearchPrograms extends ProcessPluginBase {
    ...
    switch($name) {
      ...
      */
      ...
      case 'ILRI feed and forage development program':
        ...
        $term = 'Livestock, Genetics, Nutrition, and Feed Resources';
        break;
      case 'ILRI impact at scale program':
        //$term = "Impact at scale";
        $term = 'Innovations scaling and impact';
        break;
